...
Fluxcore is pre-1.0. Security fixes are applied to the latest `main` branch.
There are currently no supported historical release branches.

## Report a vulnerability

Do not open a public issue for a suspected vulnerability. Use
[GitHub private vulnerability reporting](https://github.com/LordM8YT/Fluxcore-framework/security/advisories/new).
...
- Grant `Fluxcore.admin` and `Fluxcore.jobs.manage` only to trusted principals.
...
Fluxcore cannot protect a server from arbitrary code installed as another
