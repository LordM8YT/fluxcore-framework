...
Nord is pre-1.0. Security fixes are applied to the latest `main` branch.
There are currently no supported historical release branches.

## Report a vulnerability

Do not open a public issue for a suspected vulnerability. Use
[GitHub private vulnerability reporting](https://github.com/LordM8YT/Nord-framework/security/advisories/new).
...
- Grant `Nord.admin` and `Nord.jobs.manage` only to trusted principals.
...
Nord cannot protect a server from arbitrary code installed as another
