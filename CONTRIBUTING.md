# Contributing to Fluxcore

Fluxcore is an independent framework. Contributions may learn from public APIs and
...
- Keep `fluxcore_core` small; domain resources should consume its public API.
...
Read
[Database and Backups](https://github.com/LordM8YT/Fluxcore-framework/wiki/Database-and-Backups)
