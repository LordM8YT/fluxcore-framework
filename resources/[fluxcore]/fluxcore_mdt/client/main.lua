...
local function call(method, payload)
    ...
    TriggerServerEvent('fluxcore_mdt:server:request', requestId, method, payload or {})
...
RegisterNetEvent('fluxcore_mdt:client:response', function(requestId, response)
...
RegisterCommand('mdt', function()
    ...
    if response.ok then
        ...
        TriggerEvent('fluxcore_mdt:client:open', copy(snapshot))
    else
