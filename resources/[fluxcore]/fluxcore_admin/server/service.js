  ...
  listPlayers() {
    ...
    for (const source of this.runtime.getPlayers()) {
      try {
        ...
        // Players without a selected Fluxcore character are omitted.
      }
    }
    ...
    switch (method) {
      ...
      case 'player:freeze': {
        ...
        this.runtime.emitClient(
          target.source,
          'fluxcore_admin:client:setFrozen',
          frozen,
        );
        return { frozen };
      }
      case 'player:heal':
        this.runtime.emitClient(target.source, 'fluxcore_admin:client:heal');
        return true;
      case 'player:goto':
        this.runtime.emitClient(
          source,
          'fluxcore_admin:client:teleport',
