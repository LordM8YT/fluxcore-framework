...
Character selection, creation, deletion, and spawn choice for Fluxcore Framework.
...
When `fluxcore_identity` is running, `fluxcore_core` delegates post-login spawning to
...
server-authoritative in `fluxcore_core`.
