...
`fluxcore_inventory` is Fluxcore's server-authoritative item layer. It stores player
...
```lua
exports.fluxcore_inventory:AddItem(source, 'water', 2, {
    quality = 100
})

exports.fluxcore_inventory:RemoveItem(source, 'water', 1)
exports.fluxcore_inventory:MoveItem(source, 1, 8, 1)
exports.fluxcore_inventory:TransferItem(source, targetSource, 1, 1)

exports.fluxcore_inventory:RegisterStash(
    'police_evidence',
    'Police Evidence',
    100,
    500000
...
exports.fluxcore_inventory:RegisterContainer(
    'vehicle:AB12CD',
    'vehicle',
    'AB12CD',
    'Vehicle trunk',
...
exports.fluxcore_inventory:DeleteContainer('vehicle:veh_0123456789abcdef')

exports.fluxcore_inventory:OpenInventory(source, 'stash:police_evidence')
```
...
```js
exports.fluxcore_inventory.RegisterUsableItem('bandage', (source, item) => {
...
`fluxcore_inventory:client:updated` local event fires after every server update.

The frontend contract is documented in the
[Fluxcore Wiki](https://github.com/LordM8YT/Fluxcore-framework/wiki/UI-Contracts).
...
`fluxcore_inventory:client:uiOpenRequested` event receives the exact bootstrap
